...
exports.createOverlapOperationTools = createOverlapOperationTools;
exports.handleOverlapOperationTool = handleOverlapOperationTool;
function createOverlapOperationTools(rBridge) {
    return [
        {
...
async function handleOverlapOperationTool(toolName, args, rBridge) {
    ...
    switch (toolName) {
        case 'gutils_gr_findoverlaps': {
            ...
            if (args.maxgap !== undefined)
                cmd += `, maxgap = ${args.maxgap}`;
            if (args.minoverlap !== undefined)
        ...
        case 'gutils_gr_overlaps': {
            ...
            if (args.thresh !== undefined)
                cmd += `, thresh = ${args.thresh}`;
            cmd += ')';
            const result = await rBridge.executeRCommand(cmd);
            return rBridge.parseROutput(result);
        }
...
//# sourceMappingURL=overlap-operations.js.map